> 📜 **HISTÓRICO (mayo 2026)** — Extraído de la rama legacy `ron/simulador-financiero` (commit origen `7eb49ca`, 14-may-2026) el 2026-08-10.
> ⚠️ **Referencia del desarrollo inicial.** Los specs SDD en `docs/specs/` son la **fuente de verdad vigente** (Spec Anchor); este documento NO se implementa tal cual — algunos escenarios/criterios ya cambiaron con el desarrollo posterior.
> Origen de la decisión: opción 2 aprobada por Ron (extraer docs valiosos, sin tocar código ni specs).
